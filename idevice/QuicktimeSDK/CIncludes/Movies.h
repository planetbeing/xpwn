/*
     ...
     Copyright:  © 2006 © 1990-2006 by Apple Computer, Inc., all rights reserved
...
enum {
   ...
   */
  kQTMovieAudioExtractionMoviePropertyID_CurrentTime = FOUR_CHAR_CODE('time'), /* value is TimeRecord. Gettable/Settable.*/
   ...
   */
  kQTMovieAudioExtractionMoviePropertyID_AllChannelsDiscrete = FOUR_CHAR_CODE('disc'), /* value is Boolean. Gettable/Settable.*/
   ...
   */
  kQTMovieAudioExtractionAudioPropertyID_RenderQuality = FOUR_CHAR_CODE('qual') /* value is UInt32. Gettable/Settable.*/
};
...
enum {
   ...
   * will fail.
   */
  kQTMovieAudioExtractionAudioPropertyID_AudioStreamBasicDescription = FOUR_CHAR_CODE('asbd'),
   ...
   */
  kQTMovieAudioExtractionAudioPropertyID_AudioChannelLayout = FOUR_CHAR_CODE('clay')
};
