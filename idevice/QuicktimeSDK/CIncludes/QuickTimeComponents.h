/*
     ...
     Copyright:  © 2006 © 1990-2005 by Apple Computer, Inc., all rights reserved
...
enum {
  ...
  movieExportSourceApertureMode = FOUR_CHAR_CODE('srap') /* pointer to OSType. Source movie's aperture mode.ÊSet the aperture mode on the decompression session.*/
};
