...
#define USE_D3D8 0
#if USE_D3D8
#define CVDIRECT3DDEVICE LPDIRECT3DDEVICE8
#define CVDIRECT3DTEXTURE LPDIRECT3DTEXTURE8
#define CVDIRECT3DSURFACE LPDIRECT3DSURFACE8
#define CVDIRECT3D LPDIRECT3D8
#else
